		...
		<div id="pmpro_account-profile" class="pmpro_box">	
			...
			<p>
				<a href="<?php echo home_url( JAVO_DEF_LANG . JAVO_MEMBER_SLUG . '/' . wp_get_current_user()->user_login . '/' . JAVO_PROFILE_SLUG )?>">
					<?php _e("Edit Profile", "pmpro");?>
				</a> |
				<a href="<?php echo home_url( JAVO_DEF_LANG . JAVO_MEMBER_SLUG . '/' . wp_get_current_user()->user_login . '/' . JAVO_LOSTPW_SLUG )?>"><?php _ex("Change Password", "As in 'change password'.", "pmpro");?></a>
			</p>
